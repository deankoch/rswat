...
`rswat` includes a plaintext copy of latest SWAT+ documentation PDF ("inputs_swatplus_rev60_5.pdf", last downloaded from the SWAT+ website in October, 2022), to make it easy to access in an R environment. Call `rswat_docs` to get a `tibble` of results for a search query. Searching for a file name will usually pull up a full definitions list, along with some information about where in the PDF this text can be found.

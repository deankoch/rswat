...
So far we have only browsed the files for an existing project. The real power of rswat is in allowing R users to easily modifying the parameters in the SWAT+ config files on disk. rswat makes this more intuitive for R users by representing all config files as data frames 
